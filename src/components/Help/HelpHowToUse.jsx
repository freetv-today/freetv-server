export function HelpHowToUse() {
  return (
    <section id="using" className="mb-5">
      ...
      <p>All Favorites and Recently Watched show titles are specific to the playlist that they belong to. So, if the "Default TV Shows" playlist is selected, and you add a show title to your Favorites, you will only see that title when the "Default TV Shows" playlist is selected. If you switch to a different playlist, you will only see Favorites and Recently Viewed titles for the selected playlist. As you switch playlists you will see different Favorites and Recently Viewed show titles.</p>
