export function Help() {
	return (
        <div class="mt-5">
            ...
            <p class="fst-italic text-danger" style="padding: 20px; border: 2px dashed red; border-radius: 24px;"><b>If you're having problems</b> streaming videos, it could indicate a problem with the Internet Archive server or their internet connection. The best thing to do is to verify that your device is working by playing a <a href="https://youtube.com" target="_blank">YouTube</a> video. If the YouTube video plays correctly, <b>it could mean that the Internet Archive servers are having temporary problems</b>. The best thing to do is wait awhile and try again later. Free TV is dependent on the Internet Archive servers to stream videos. <b>If they're having problems, so are we!</b></p>
            ...
            <p class="lead">Free TV is an app to watch videos featuring a hand-picked list of TV shows and movies from the <a href="https://archive.org" target="_blank">Internet Archive</a>.</p> 
            ...
            <p class="mt-4 mb-0">
                <ul>
                    <li><a href="/help" class="fs-5" target="_top">Frequently Asked Questions</a></li>
                    <li><a href="/help" class="fs-5" target="_top">Version Information</a></li>
                </ul>
            </p>
            ...
            <div class="d-flex flex-row w-100 justify-content-center align-middle gap-3 mb-4">
                <div class="text-center text-secondary">
                    Small Screen<br/>
                    <a href="/src/assets/help_freetv_ui_sm.png" target="_blank" class="text-decoration-none" title="Click to see full-sized version of Small Screen interface"><img src="/src/assets/help_freetv_ui_sm.png" class="img-fluid border border-2 border-dark" /></a>
                </div>
                <div class="text-center text-secondary">
                    Large Screen<br/>
                    <a href="/src/assets/help_freetv_ui_lg.png" target="_blank" class="text-decoration-none" title="Click to see full-sized version of Large Screen interface"><img src="/src/assets/help_freetv_ui_lg.png" class="img-fluid border border-2 border-dark" /></a>     
                </div>
            </div>
            ...
            <div class="d-flex flex-row w-100 justify-content-center align-middle gap-3">
                <div class="text-center text-secondary">
                    Small Screen<br/>
                    <a href="/src/assets/help_video_ui_sm.png" target="_blank" class="text-decoration-none" title="Click to see full-sized version of Small Screen interface"><img src="/src/assets/help_video_ui_sm.png" class="img-fluid border border-2 border-dark"/></a>
                </div>
                <div class="text-center text-secondary">
                    Large Screen<br/>
                    <a href="/src/assets/help_video_ui_lg.png" target="_blank" class="text-decoration-none" title="Click to see full-sized version of Large Screen interface"><img src="/src/assets/help_video_ui_lg.png" class="img-fluid border border-2 border-dark" /></a>     
                </div>
            </div>
        ...
        <div class="container my-5">
            ...
            <p>
                <div class="accordion" id="accordionFAQ">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                        ...
                        <p><strong>No.</strong> All of the content for this app comes from The Internet Archive: a digital library of Internet sites and other cultural artifacts. Any content on this site can be found by going dirctly to the Internet Archive and <a href="https://archive.org/details/movies" target="_blank">searching</a> their archive of shows. This site is simply a hand-curated list of shows organized by category.</p>

                        <figure class="figure p-2 border border-2 border-primary text-end float-md-end me-md-3 w-md-50 m-3">
                            <a href="/src/assets/archive-org.png" target="_blank"><img src="/src/assets/archive-org.png" width="350" class="figure-img rounded" /></a>
                        ...
                        <p class="text-center my-5">
                            <a href="https://archive.org" title="Link opens in a new tab or window" target="_blank" class="btn btn-large btn-outline-dark fw-bold p-4 shadow">Visit the Internet Archive<img src="/src/assets/external-link.svg" width="15" class="ms-2" /></a>
                        </p>
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                        ...
                        <p>If you click the "IMDB Page" button, it will open up a new tab or window with the <a href="https://www.imdb.com" target="_blank">IMDB</a> page for that TV show where you can look up actors, directors, dates, plot summaries, etc.</p>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionFAQ">
                            <div class="accordion-body">
                                ...
                                <p>Otherwise, if you want to request new features or shows, or tell  me about typos, or bugs, or ask questions, you can reach me by email.
                                    <br/><br/>
                                <a id="contactEmail" href="javascript:void(0)" class="fs-4"></a>
                                </p>
                            </div>
                        </div>
                    </div>                
            ...
            <p class="text-center my-5">
                <a href="/help" class="btn btn-sm btn-primary" target="_top">Back to Top &#9650;</a>
            </p>
            ...
            <div class="my-5 text-center">
                ...
                <a href="/" target="_top"><img src="/src/assets/freetv.png" width="185" title="Free TV" alt="Free TV Logo" /></a>
            </div>

            <p class="my-5">
                <div class="fs-4 fw-bold text-center">
                    <a href="https://archive.org" class="link-dark text-decoration-none" target="_blank" title="Powered by the Internet Archive">
