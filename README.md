...
FreeTV does not install MariaDB or create database accounts! For specific information on how do do this refer to the [MariaDB Documentation](https://mariadb.com/docs/server/mariadb-quickstart-guides/installing-mariadb-server-guide). 
